...
**recurring** | Option<[**models::UsageTriggerEnumRecurring**](usage_trigger_enum_recurring.md)> |  |  |
**trigger_by** | Option<[**models::UsageTriggerEnumTriggerField**](usage_trigger_enum_trigger_field.md)> |  |  |
...
**recurring** | Option<[**UsageTriggerEnumRecurring**](.md)> | The frequency of recurring UsageTriggers to read. Can be: `daily`, `monthly`, or `yearly` to read recurring UsageTriggers. An empty value or a value of `alltime` reads non-recurring UsageTriggers. |  |
**trigger_by** | Option<[**UsageTriggerEnumTriggerField**](.md)> | The trigger field of the UsageTriggers to read.  Can be: `count`, `usage`, or `price` as described in the [UsageRecords documentation](https://www.twilio.com/docs/usage/api/usage-record#usage-count-price). |  |
