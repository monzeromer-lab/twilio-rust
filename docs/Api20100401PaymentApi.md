...
> models::ApiV2010AccountCallPayments create_payments(account_sid, call_sid, idempotency_key, status_callback, bank_account_type, charge_amount, currency, description, input, min_postal_code_length, parameter, payment_connector, payment_method, postal_code, security_code, timeout, token_type, valid_card_types)
...
**bank_account_type** | Option<[**models::PaymentsEnumBankAccountType**](payments_enum_bank_account_type.md)> |  |  |
...
**payment_method** | Option<[**models::PaymentsEnumPaymentMethod**](payments_enum_payment_method.md)> |  |  |
...
**token_type** | Option<[**models::PaymentsEnumTokenType**](payments_enum_token_type.md)> |  |  |
...
**capture** | Option<[**models::PaymentsEnumCapture**](payments_enum_capture.md)> |  |  |
**status** | Option<[**models::PaymentsEnumStatus**](payments_enum_status.md)> |  |  |
