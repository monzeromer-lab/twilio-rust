...
**address_requirements** | Option<[**models::IncomingPhoneNumberLocalEnumAddressRequirement**](incoming_phone_number_local_enum_address_requirement.md)> |  | [optional]
...
**voice_receive_mode** | Option<[**models::IncomingPhoneNumberLocalEnumVoiceReceiveMode**](incoming_phone_number_local_enum_voice_receive_mode.md)> |  | [optional]
...
**emergency_status** | Option<[**models::IncomingPhoneNumberLocalEnumEmergencyStatus**](incoming_phone_number_local_enum_emergency_status.md)> |  | [optional]
...
**emergency_address_status** | Option<[**models::IncomingPhoneNumberLocalEnumEmergencyAddressStatus**](incoming_phone_number_local_enum_emergency_address_status.md)> |  | [optional]
