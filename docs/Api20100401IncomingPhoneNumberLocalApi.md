...
**emergency_status** | Option<[**models::IncomingPhoneNumberLocalEnumEmergencyStatus**](incoming_phone_number_local_enum_emergency_status.md)> |  |  |
...
**voice_receive_mode** | Option<[**models::IncomingPhoneNumberLocalEnumVoiceReceiveMode**](incoming_phone_number_local_enum_voice_receive_mode.md)> |  |  |
