...
**content_retention** | Option<[**models::MessageEnumContentRetention**](message_enum_content_retention.md)> |  |  |
**address_retention** | Option<[**models::MessageEnumAddressRetention**](message_enum_address_retention.md)> |  |  |
...
**traffic_type** | Option<[**models::MessageEnumTrafficType**](message_enum_traffic_type.md)> |  |  |
...
**schedule_type** | Option<[**models::MessageEnumScheduleType**](message_enum_schedule_type.md)> |  |  |
...
**risk_check** | Option<[**models::MessageEnumRiskCheck**](message_enum_risk_check.md)> |  |  |
...
**status** | Option<[**models::MessageEnumUpdateStatus**](message_enum_update_status.md)> |  |  |
