...
**emergency_status** | Option<[**models::IncomingPhoneNumberTollFreeEnumEmergencyStatus**](incoming_phone_number_toll_free_enum_emergency_status.md)> |  |  |
...
**voice_receive_mode** | Option<[**models::IncomingPhoneNumberTollFreeEnumVoiceReceiveMode**](incoming_phone_number_toll_free_enum_voice_receive_mode.md)> |  |  |
