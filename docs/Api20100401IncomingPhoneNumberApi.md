...
**emergency_status** | Option<[**models::IncomingPhoneNumberEnumEmergencyStatus**](incoming_phone_number_enum_emergency_status.md)> |  |  |
...
**voice_receive_mode** | Option<[**models::IncomingPhoneNumberEnumVoiceReceiveMode**](incoming_phone_number_enum_voice_receive_mode.md)> |  |  |
