...
pub async fn create_call_recording(configuration: &configuration::Configuration, params: CreateCallRecordingParams) -> Result<models::ApiV2010AccountCallCallRecording, Error<CreateCallRecordingError>> {

    let uri_str = format!("{}/2010-04-01/Accounts/{AccountSid}/Calls/{CallSid}/Recordings.json", configuration.base_path, AccountSid=crate::apis::urlencode(params.account_sid), CallSid=crate::apis::urlencode(params.call_sid));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ApiV2010AccountCallCallRecording`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ApiV2010AccountCallCallRecording`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn delete_call_recording(configuration: &configuration::Configuration, params: DeleteCallRecordingParams) -> Result<(), Error<DeleteCallRecordingError>> {
    ...
    let uri_str = format!("{}/2010-04-01/Accounts/{AccountSid}/Calls/{CallSid}/Recordings/{Sid}.json", configuration.base_path, AccountSid=crate::apis::urlencode(params.account_sid), CallSid=crate::apis::urlencode(params.call_sid), Sid=crate::apis::urlencode(params.sid));
...
pub async fn fetch_call_recording(configuration: &configuration::Configuration, params: FetchCallRecordingParams) -> Result<models::ApiV2010AccountCallCallRecording, Error<FetchCallRecordingError>> {
...
pub async fn list_call_recording(configuration: &configuration::Configuration, params: ListCallRecordingParams) -> Result<models::ListCallRecordingResponse, Error<ListCallRecordingError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ListCallRecordingResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ListCallRecordingResponse`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn update_call_recording(configuration: &configuration::Configuration, params: UpdateCallRecordingParams) -> Result<models::ApiV2010AccountCallCallRecording, Error<UpdateCallRecordingError>> {
