...
/// 
pub async fn create_incoming_phone_number_local(configuration: &configuration::Configuration, params: CreateIncomingPhoneNumberLocalParams) -> Result<models::ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal, Error<CreateIncomingPhoneNumberLocalError>> {

    let uri_str = format!("{}/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/Local.json", configuration.base_path, AccountSid=crate::apis::urlencode(params.account_sid));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateIncomingPhoneNumberLocalError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// 
pub async fn list_incoming_phone_number_local(configuration: &configuration::Configuration, params: ListIncomingPhoneNumberLocalParams) -> Result<models::ListIncomingPhoneNumberLocalResponse, Error<ListIncomingPhoneNumberLocalError>> {
