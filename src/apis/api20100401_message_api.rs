...
/// Send a message
pub async fn create_message(configuration: &configuration::Configuration, params: CreateMessageParams) -> Result<models::ApiV2010AccountMessage, Error<CreateMessageError>> {

    let uri_str = format!("{}/2010-04-01/Accounts/{AccountSid}/Messages.json", configuration.base_path, AccountSid=crate::apis::urlencode(params.account_sid));
    ...
    if let Some(param_value) = params.persistent_action {
        multipart_form_params.insert("PersistentAction", param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string());
    }
    ...
    if let Some(param_value) = params.media_url {
        multipart_form_params.insert("MediaUrl", param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string());
    }
...
pub async fn delete_message(configuration: &configuration::Configuration, params: DeleteMessageParams) -> Result<(), Error<DeleteMessageError>> {
    ...
    let uri_str = format!("{}/2010-04-01/Accounts/{AccountSid}/Messages/{Sid}.json", configuration.base_path, AccountSid=crate::apis::urlencode(params.account_sid), Sid=crate::apis::urlencode(params.sid));
...
pub async fn fetch_message(configuration: &configuration::Configuration, params: FetchMessageParams) -> Result<models::ApiV2010AccountMessage, Error<FetchMessageError>> {
...
pub async fn update_message(configuration: &configuration::Configuration, params: UpdateMessageParams) -> Result<models::ApiV2010AccountMessage, Error<UpdateMessageError>> {
