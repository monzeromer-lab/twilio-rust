...
pub async fn create_realtime_transcription(configuration: &configuration::Configuration, params: CreateRealtimeTranscriptionParams) -> Result<models::ApiV2010AccountCallRealtimeTranscription, Error<CreateRealtimeTranscriptionError>> {

    let uri_str = format!("{}/2010-04-01/Accounts/{AccountSid}/Calls/{CallSid}/Transcriptions.json", configuration.base_path, AccountSid=crate::apis::urlencode(params.account_sid), CallSid=crate::apis::urlencode(params.call_sid));
...
pub async fn update_realtime_transcription(configuration: &configuration::Configuration, params: UpdateRealtimeTranscriptionParams) -> Result<models::ApiV2010AccountCallRealtimeTranscription, Error<UpdateRealtimeTranscriptionError>> {

    let uri_str = format!("{}/2010-04-01/Accounts/{AccountSid}/Calls/{CallSid}/Transcriptions/{Sid}.json", configuration.base_path, AccountSid=crate::apis::urlencode(params.account_sid), CallSid=crate::apis::urlencode(params.call_sid), Sid=crate::apis::urlencode(params.sid));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
