...
pub async fn create_usage_trigger(configuration: &configuration::Configuration, params: CreateUsageTriggerParams) -> Result<models::ApiV2010AccountUsageUsageTrigger, Error<CreateUsageTriggerError>> {

    let uri_str = format!("{}/2010-04-01/Accounts/{AccountSid}/Usage/Triggers.json", configuration.base_path, AccountSid=crate::apis::urlencode(params.account_sid));
...
pub async fn delete_usage_trigger(configuration: &configuration::Configuration, params: DeleteUsageTriggerParams) -> Result<(), Error<DeleteUsageTriggerError>> {
    ...
    let uri_str = format!("{}/2010-04-01/Accounts/{AccountSid}/Usage/Triggers/{Sid}.json", configuration.base_path, AccountSid=crate::apis::urlencode(params.account_sid), Sid=crate::apis::urlencode(params.sid));
...
pub async fn fetch_usage_trigger(configuration: &configuration::Configuration, params: FetchUsageTriggerParams) -> Result<models::ApiV2010AccountUsageUsageTrigger, Error<FetchUsageTriggerError>> {
...
pub async fn list_usage_trigger(configuration: &configuration::Configuration, params: ListUsageTriggerParams) -> Result<models::ListUsageTriggerResponse, Error<ListUsageTriggerError>> {

    let uri_str = format!("{}/2010-04-01/Accounts/{AccountSid}/Usage/Triggers.json", configuration.base_path, AccountSid=crate::apis::urlencode(params.account_sid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = params.recurring {
        req_builder = req_builder.query(&[("Recurring", &serde_json::to_string(param_value)?)]);
    }
    if let Some(ref param_value) = params.trigger_by {
        req_builder = req_builder.query(&[("TriggerBy", &serde_json::to_string(param_value)?)]);
    }
...
pub async fn update_usage_trigger(configuration: &configuration::Configuration, params: UpdateUsageTriggerParams) -> Result<models::ApiV2010AccountUsageUsageTrigger, Error<UpdateUsageTriggerError>> {
