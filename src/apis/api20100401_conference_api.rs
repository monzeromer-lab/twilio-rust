...
pub async fn fetch_conference(configuration: &configuration::Configuration, params: FetchConferenceParams) -> Result<models::ApiV2010AccountConference, Error<FetchConferenceError>> {

    let uri_str = format!("{}/2010-04-01/Accounts/{AccountSid}/Conferences/{Sid}.json", configuration.base_path, AccountSid=crate::apis::urlencode(params.account_sid), Sid=crate::apis::urlencode(params.sid));
...
pub async fn list_conference(configuration: &configuration::Configuration, params: ListConferenceParams) -> Result<models::ListConferenceResponse, Error<ListConferenceError>> {

    let uri_str = format!("{}/2010-04-01/Accounts/{AccountSid}/Conferences.json", configuration.base_path, AccountSid=crate::apis::urlencode(params.account_sid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// 
pub async fn update_conference(configuration: &configuration::Configuration, params: UpdateConferenceParams) -> Result<models::ApiV2010AccountConference, Error<UpdateConferenceError>> {
