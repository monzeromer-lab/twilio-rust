...
pub async fn create_incoming_phone_number(configuration: &configuration::Configuration, params: CreateIncomingPhoneNumberParams) -> Result<models::ApiV2010AccountIncomingPhoneNumber, Error<CreateIncomingPhoneNumberError>> {

    let uri_str = format!("{}/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers.json", configuration.base_path, AccountSid=crate::apis::urlencode(params.account_sid));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ApiV2010AccountIncomingPhoneNumber`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ApiV2010AccountIncomingPhoneNumber`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn delete_incoming_phone_number(configuration: &configuration::Configuration, params: DeleteIncomingPhoneNumberParams) -> Result<(), Error<DeleteIncomingPhoneNumberError>> {
    ...
    let uri_str = format!("{}/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/{Sid}.json", configuration.base_path, AccountSid=crate::apis::urlencode(params.account_sid), Sid=crate::apis::urlencode(params.sid));
...
pub async fn fetch_incoming_phone_number(configuration: &configuration::Configuration, params: FetchIncomingPhoneNumberParams) -> Result<models::ApiV2010AccountIncomingPhoneNumber, Error<FetchIncomingPhoneNumberError>> {
...
pub async fn list_incoming_phone_number(configuration: &configuration::Configuration, params: ListIncomingPhoneNumberParams) -> Result<models::ListIncomingPhoneNumberResponse, Error<ListIncomingPhoneNumberError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ListIncomingPhoneNumberResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ListIncomingPhoneNumberResponse`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn update_incoming_phone_number(configuration: &configuration::Configuration, params: UpdateIncomingPhoneNumberParams) -> Result<models::ApiV2010AccountIncomingPhoneNumber, Error<UpdateIncomingPhoneNumberError>> {
    ...
    let mut multipart_form_params = std::collections::HashMap::new();
    if let Some(param_value) = params.account_sid2 {
