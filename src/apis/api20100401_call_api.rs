...
pub async fn create_call(configuration: &configuration::Configuration, params: CreateCallParams) -> Result<models::ApiV2010AccountCall, Error<CreateCallError>> {

    let uri_str = format!("{}/2010-04-01/Accounts/{AccountSid}/Calls.json", configuration.base_path, AccountSid=crate::apis::urlencode(params.account_sid));
...
pub async fn delete_call(configuration: &configuration::Configuration, params: DeleteCallParams) -> Result<(), Error<DeleteCallError>> {
    ...
    let uri_str = format!("{}/2010-04-01/Accounts/{AccountSid}/Calls/{Sid}.json", configuration.base_path, AccountSid=crate::apis::urlencode(params.account_sid), Sid=crate::apis::urlencode(params.sid));
...
pub async fn fetch_call(configuration: &configuration::Configuration, params: FetchCallParams) -> Result<models::ApiV2010AccountCall, Error<FetchCallError>> {
...
pub async fn update_call(configuration: &configuration::Configuration, params: UpdateCallParams) -> Result<models::ApiV2010AccountCall, Error<UpdateCallError>> {
